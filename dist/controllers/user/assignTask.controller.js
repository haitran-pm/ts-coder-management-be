...
const assignTask = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedTask = yield Task_1.default.findByIdAndUpdate({ _id: taskId }, { user: userId }, { new: true });
        // Gửi kết quả
        (0, utils_1.sendResponse)(res, 201, true, updatedTask, null, "User assigned successfully");
    }
    catch (err) {
        next(err);
    }
